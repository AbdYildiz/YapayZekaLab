...
dataDir = 'C:/Users/mehmet/.spyder-py3/Mermer Analiz/train' # veri setinin pc'de ki yolu
...
while True:
    try:
        ...
        print('Beklenmedik bir hatayla karşılaştık. Lütfen resmi tekrar yükleyin...\nHata: ', e)
